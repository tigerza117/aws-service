    ...
    <div class="flex flex-col max h-screen bg-gray-800 justify-center items-center pb-40">
		<div class="w-full max-w-sm p-4 rounded-lg shadow-md sm:p-6 md:p-8 bg-gray-700 border-gray-700">
			<div class="space-y-8 w-full">
				...
				<div>
					<label for="password"  class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">Your Password:</label>
				...
				<button type="submit" on:click={handleClick} class="w-full focus:ring-4 focus:outline-none rounded-lg text-xl font-bold px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Login To Your Account</button>
